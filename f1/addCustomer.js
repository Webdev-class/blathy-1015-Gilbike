...
function addCustomer(name, age, address, newsLetter) {
  if (!isAddress(address) || isCustomer(name, age, address, newsLetter)) return false;
  if (typeof age != "number") return false;
  return [...customers, { id: customers[customers.length - 1].id + 1, name, age, address, newsLetter }];
}
